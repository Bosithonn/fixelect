...
<p align="center">
  <a href="docs/fixelect-intro.mp4"><img src="docs/demo.webp" alt="Select text, double-tap Alt, and the typos are fixed in place, in any app" width="100%"></a>
  <br>
  <sub><a href="docs/fixelect-intro.mp4">▶ Watch the 48-second video with sound</a></sub>
</p>
